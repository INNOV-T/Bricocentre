...
$requeteP = $connection->query('SELECT NomFournisseur,NIF,STAT,adresse FROM fournisseur ORDER BY idFournisseur DESC');
...
if(isset($_GET['btn'])){
  $requete = $connection->query("INSERT INTO `fournisseur`(`NomFournisseur`, `NIF`, `STAT`, `Adresse`) VALUES ('$nom','$nif','$stat','$adresse')");
  if($requete){
    ...
    <aside class="maping">
        <div class="container p-4">
            ...
            <div class="menu mt-5">
                ...
                <a href="" class="btn btn-light active"><i class="fa fa-user-circle"></i> Fournisseurs</a>
    ...
    <section class="contenu">
        <div class="container-fluid pt-2">
            <div class="header p-3">
              ...
              <!-- MODALE PRODUIT -->
          <div class="modale">
            <div class="ajout-cli p-3 mt-2"  style="margin-top: 15vh !important;">
              <!-- <p class="alert alert-secondary"><i class="fa fa-plus-square"></i> Ajouter une nouvelle client</p> -->
              <div class="formulaire p-4">
                <p class="alert alert-warning"><i class="fa fa-plus-square"></i> Ajouter une nouvelle fournisseur</p>
                <form>
                  <div class="simple p-3">
                    <input type="text" class="form-control" placeholder="Nom du fournisseur" name="nom">
                    <div class="center">
                      <input type="text" class="form-control mt-3" placeholder="NIF" name="nif">
                      <input type="text" class="form-control mt-3" placeholder="STAT" style="margin-left: 2%;" name="stat">
                    </div>
                    <input type="text" class="form-control mt-3" placeholder="Adresse" name="adresse">
                  </div>
              
                  <div>
                    <button class="btn btn-primary m-3" type="submit" name="btn"><i class="fa fa-check-circle"></i> Enregistrer le fournisseur</button>
          ...
          <!-- FIN MODALE PRODUIT -->
            <div class="stats mt-2  p-2 bg-light">
                <p class="p-3"><i class="fa fa-users"></i> Listes des vos fournisseurs chez <b>Bricocentre Fianarantsoa</b> <button class="btn btn-primary btn-sm" style="float: right;" onclick="show()"><i class="fa fa-plus-circle"></i> Ajouter une nouvelle fournisseur</button></p>
                <div class="center">
                ...
                >
                  ...
                  <?php foreach ($resultatP as $keys) : ?>
                    ...
                    <div class="charts p-4">
                        <p><i class="fa fa-bar-chart"></i> Evaluation des fournisseurs</p>
