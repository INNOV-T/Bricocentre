      ...
      <main>
        ...
        <section class="contenu">
          <div class="container-fluid p-3">
            <p class="alert alert-secondary"><i class="fa fa-users"></i> Gestion des produits chez <b class="text-warning">Bricocentre Fianarantsoa</b></p>
            <div class="clients p-3">
                ...
                <div class="list p-3">
                    <p>
                        <i class="fa fa-calendar-check"></i> Listes des produits existants chez <b class="text-primary">Bricocentre Fianarantsoa</b>
                      </p>
                      <div class="listes">
                        <table
